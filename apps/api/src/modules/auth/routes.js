...
import {
    ...
    refreshTokenSchema,
    resendOtpSchema,
} from "@packages/common/schemas/auth.schema.js";
import { authMiddleware } from "../../middlewares/auth.js";

export function authRoutes() {
    const router = Router();

    const otpRateLimit = rateLimitMiddleware({
        windowMs: 5 * 60 * 1000,
        max: 5,
        keyPrefix: "rl:otp:",
    });
    ...
    router.post("/refresh", validateMiddleware(refreshTokenSchema), refreshController);
